 ...
 * @author jayks
 */
public class TraitementListePlat extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TraitementListePlat</title>");            
            out.println("</head>");
            out.println("<body>");
            try {
                ...
                Produit[] listeProduit = p.getProduits();
                request.setAttribute("listeProduit", listeProduit);
                Produit[] dessert = p.getProduitsCatgorie(1);
                request.setAttribute("dessert", dessert);
                Produit[] resistance = p.getProduitsCatgorie(2);
                request.setAttribute("resistance", resistance);
                Produit[] entree = p.getProduitsCatgorie(3);
