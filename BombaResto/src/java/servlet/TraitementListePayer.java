 ...
 * @author Rado
 */
public class TraitementListePayer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet TraitementListePayer</title>");            
            out.println("</head>");
            out.println("<body>");
            try {
                ...
                RequestDispatcher dispatch = request.getRequestDispatcher("ListePayer.jsp");
