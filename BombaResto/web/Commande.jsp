				...
				<div class="col-md-6 p-t-45 p-b-30">
					<div class="wrap-text-welcome t-center">
						...
						<p class="t-center m-b-22 size3 m-l-r-auto">
							Un restaurant malagasy spécialisé en cuisine italienne et malagasy.
						</p>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="menu.html"><img src="images/intro-01.jpg" alt="IMG-INTRO"></a>
							</div>
							...
							<div class="wrap-text-blo1 p-t-35">
								...
								<p class="m-b-20">
									Vous pouvez organisez un petit rendez-vous romantique pour votre amant(e)
								</p>
					...
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="menu.html"><img src="images/intro-02.jpg" alt="IMG-INTRO"></a>
							</div>
							...
							<div class="wrap-text-blo1 p-t-35">
								...
								<p class="m-b-20">
									Notre restaurant va pouvoir vous satisfaire grace à sa bonne qualité 
								</p>
					...
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="menu.html"><img src="images/intro-04.jpg" alt="IMG-INTRO"></a>
							</div>

							<div class="wrap-text-blo1 p-t-35">
								<a href="menu.html"><h4 class="txt5 color0-hov trans-0-4 m-b-13">
									Des vins provenant de Madagascar
								</h4></a>

								<p class="m-b-20">
									Fianarantsoa une province de Madagascar fabriquant du délicieux vins
								</p>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="wrap-inputpersonne size12 bo2 bo-rad-10 m-t-3 m-b-23">
										<!-- Select2 -->
										<select class="selection-1" name="personne">
											<option>1 personne</option>
											<option>2 personne</option>
											<option>3 personne</option>
											<option>4 personne</option>
											<option>5 personne</option>
											<option>6 personne</option>
											<option>7 personne</option>
											<option>8 personne</option>
											<option>9 personne</option>
											<option>10 personne</option>
											<option>11 personne</option>
											<option>12 personne</option>
										</select>
									</div>
								</div>
						...
						<div class="container">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="zoomIn">
								...
								<div class="wrap-text-blo2 flex-col-c-m p-l-40 p-r-40 p-t-45 p-b-30">
									...
									<p class="t-center">
										Des évènements avec des artistes célèbres pour vous mettre plus dans le feeling
									</p>
